...
class WordsLearnShow extends StatefulWidget {
  var alphaName = "", alpha = "", content = "";
  WordsLearnShow(this.alphaName, this.alpha, this.content);

  @override
  _WordsLearnShowState createState() =>
      _WordsLearnShowState(this.alphaName, this.alpha, this.content);
}

class _WordsLearnShowState extends State<WordsLearnShow> {
  var alphaName = "", alpha = "", content = "";
